...
class PostAssetFactory:
    ...
    def create_assets_from_mapping_and_write_to_file(self, start_assets: Iterable[OTLObject], output_directory: Path, output_file_name: str ='output', keep_original_attributes: bool = True):
        ...
        for i, asset in enumerate(start_assets):
            template_created_assets.extend(
                self.create_assets_from_mapping(
                    asset
                    , unique_index=i, keep_original_attributes=keep_original_attributes
                )
            )
